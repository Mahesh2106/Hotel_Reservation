# Generated by Django 3.2.10 on 2023-09-11 05:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Hotel_frontend', '0040_alter_booking_booking_date'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='booking',
            name='Booking_Date',
            field=models.DateField(default=datetime.datetime(2023, 9, 11, 11, 3, 41, 396153)),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cust', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Hotel_frontend.registration')),
            ],
        ),
    ]
